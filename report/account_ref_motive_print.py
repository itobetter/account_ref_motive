...
class report_print_stub(report_print_ref):
    MAX_LINES = None


report_sxw.report_sxw(
    'report.report.account.re.in.check',
    'account.voucher',
    'account_ref_motive/report/account_ref_voucher_print.rml',
    parser=report_print_ref, header=False
)

report_sxw.report_sxw(
    'report.report.account.re.out.check',
    'account.voucher',
    'account_ref_motive/report/account_ref_voucher_print.rml',
    parser=report_print_ref, header=False
)
